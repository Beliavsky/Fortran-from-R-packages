...
flags="-std=f2018 -O0 -g -Wall -Wextra -Wpedantic -Werror \
-Wno-compare-reals -fcheck=all -fbacktrace \
-ffpe-trap=invalid,zero,overflow -finit-real=snan -finit-integer=-999999"
...
echo "GNU Fortran debug validation: PASS"
