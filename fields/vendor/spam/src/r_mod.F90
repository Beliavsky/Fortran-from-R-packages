...
public :: dp, runif1, runif_vec, rnorm1, rnorm_vec, rexp, rgamma, rbeta, rchisq, rt_vec, rf_rng, rlogis, rlnorm, &
   ...
   & cumsum, cumprod, cummax, diff, diag, toeplitz, chol, chol2inv, forwardsolve, backsolve, sort, sort_list, polyroot, &
      & decompose, ecdf_eval, &
   & nchar, char_join, char_ends_with, int_to_string, real_to_string_f, real_to_string_g, r_to_string_real, r_substr, &
      & r_substr_replace, getwd, tempfile, file_path, file_exists, file_create, file_remove, file_info_t, file_info, &
      & file_isdir, file_size, file_path_value, file_mode, file_mtime, file_ctime, file_atime, file_exe, &
