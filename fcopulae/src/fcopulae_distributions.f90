...
module fcopulae_distributions
  use fcopulae_kinds, only : dp, i8, pi, log_two_pi
  use fcopulae_rng, only : rng_state, seed_rng, normal_rng, chi_square_rng
  use fcopulae_special, only : normal_cdf, normal_quantile, student_t_cdf, &
    student_t_quantile
  use fcopulae_integration, only : integration_result, integrate_1d
  use fcopulae_linalg, only : cholesky_lower, inverse_spd, logdet_spd
  implicit none
  private
...
end module fcopulae_distributions
