program lowrank_example
    use lowrankqp_kinds, only : dp
    use lowrankqp, only : lowrankqp_options, lowrankqp_result, solve_low_rank_qp, LRQP_PFCF
    implicit none
    real(dp) :: v(6,3), d(6), a(3,6), b(3), u(6)
    ...
    print '(a,es14.6)', 'termination = ',res%termination
end program lowrank_example
