...
# from Jennrich, Psychometrika, 2002, solution for the Thurstone 20 box problem.
# Specifying 27 elements to be 0 as discussed in that article (Table 1 at 
...
# This is a good test case for both TargetQ  
# (It could also be adapted for pst but there is already a test for it.)

require("GPArotation")
data(Thurstone)   # loads box20 and box26
...
# a simplified target matrix, with NAs for free and 0 for constrained.
Target <- t(matrix(c(
   0, NA,  0,
  NA,  0,  0,
   0,  0, NA,
