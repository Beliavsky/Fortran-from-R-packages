...
The dependency-free [`rfortran-optional`](rfortran-optional/) library provides
the shared `optval` generic for concise, safe defaults for optional character,
integer, logical, and working-precision real arguments.

The [`rfortran-core`](rfortran-core/) library is the first step toward removing
duplicate R-like numerical helpers from the translations. Its modules currently
provide kinds, missing-value policies, weighted and unweighted
...
`mclust`, and `SpatialExtremes`.

The transitional [`rfortran-compat`](rfortran-compat/) package holds one shared
copy of the broader MIT-licensed R-to-Fortran compatibility runtime used by
older generated translations. Its module is named `r_compat`, allowing it to
coexist with the focused `rfortran-core` facade. Fourteen newly added packages
now use this shared copy instead of embedding approximately 648 KB apiece.
Generally useful compatibility procedures can be migrated gradually into the
focused shared modules without changing the existing translated APIs.
...
| [`ape`](ape/) | Provides phylogenetic tree algorithms, evolutionary models, comparative methods, and related statistical computations. | `5.8.1` · `GPL-2.0-only OR GPL-3.0-only` |
...
| [`BivKLD`](BivKLD/) | Estimates directed bivariate Kullback-Leibler divergence using kernel density estimates and exact parametric formulas. | `0.1.0` · `GPL-3.0-only` |
...
| [`changepoint`](changepoint/) | Detects changes in means, variances, distributions, and regression relationships. | `2.3` · `GPL` |
...
| [`classInt`](classInt/) | Constructs class intervals for statistical mapping using clustering and other methods. | `0.4-11` · `GPL-2.0-or-later` |
...
| [`cmprsk`](cmprsk/) | Estimates cumulative incidence and fits Fine-Gray regression models for competing risks. | `0.1.0` · `GPL-2.0-or-later` |
| [`coda`](coda/) | Analyzes and diagnoses Markov-chain Monte Carlo output. | `0.19-4.1` · `GPL-2.0-or-later` |
| [`combinat`](combinat/) | Provides combinatorial utilities for permutations, combinations, and multinomial coefficients. | `0.0-8` · `GPL-2.0-only` |
...
| [`CompQuadForm`](CompQuadForm/) | Computes distribution functions for quadratic forms in normal variables using exact and approximate methods. | `1.4.4` · `GPL-2.0-or-later` |
...
| [`dbscan`](dbscan/) | Performs density-based clustering, nearest-neighbor search, and local outlier detection. | `1.2.6` · `GPL-2.0-or-later` |
| [`dccmidas`](dccmidas/) | Fits multivariate volatility and correlation models, including DCC, DCC-MIDAS, DECO, and BEKK. | `0.1.3` · `GPL-3.0-only` |
...
| [`deldir`](deldir/) | Computes Delaunay triangulations and Dirichlet/Voronoi tessellations. | `2.0-4` · `GPL-2.0-or-later` |
...
| [`dlm`](dlm/) | Performs Bayesian and likelihood analysis of dynamic linear models. | `1.1-6.1` · `GPL-2.0-or-later` |
| [`Dowd`](Dowd/) | Provides quantitative financial risk-management calculations. | `0.12` · `GPL-2.0-only OR GPL-3.0-only` |
| [`dplyr`](dplyr/) | Provides a grammar of data manipulation for typed heterogeneous tables. | `1.2.1` · `MIT` |
| [`DPQ`](DPQ/) | Provides accurate density, probability, and quantile calculations and approximations. | `0.6-1` · `GPL-3.0-or-later` |
| [`Dykstra`](Dykstra/) | Solves quadratic programs using cyclic projections. | `1.0-0` · `GPL-2.0-or-later` |
| [`e1071`](e1071/) | Provides support-vector machines, clustering, naive Bayes, nearest neighbors, and related statistical methods. | `1.7-17` · `GPL-2.0-only OR GPL-3.0-only` |
...
| [`evd`](evd/) | Provides distributions and methods for univariate and multivariate extreme-value analysis. | `2.3-7.1` · `GPL-3.0-only` |
...
| [`flexmix`](flexmix/) | Fits finite mixtures of regression and clustering models using EM, with inference and model selection. | `2.3-21` · `GPL-2.0-or-later` |
...
| [`forcats`](forcats/) | Provides tools for working with categorical variables and their levels. | `1.0.1` · `MIT` |
| [`forecast`](forecast/) | Provides forecasting methods for exponential-smoothing, ARIMA, BATS, TBATS, and related time-series models. | `9.0.2` · `GPL-3.0-only` |
...
| [`gamm4`](gamm4/) | Fits generalized additive mixed models by combining smooth terms and mixed-model estimation. | `0.3-0` · `GPL-2.0-or-later` |
...
| [`gbm3`](gbm3/) | Fits stochastic gradient-boosted trees for regression and related prediction problems. | `3.0.3` · `GPL-2.0-or-later` |
| [`gcpm`](gcpm/) | Models credit-portfolio risk analytically and by Monte Carlo simulation. | `1.2.2` · `GPL-2.0-only` |
| [`geepack`](geepack/) | Fits generalized estimating equations for clustered and longitudinal data. | `0.1.0` · `GPL-3.0-or-later` |
...
| [`gmm`](gmm/) | Fits generalized method of moments and generalized empirical likelihood models. | `1.9-1` · `GPL-2.0-or-later` |
| [`gmp`](gmp/) | Provides pure-Fortran multiple-precision integer and rational arithmetic. | `0.7-5.1` · `GPL-2.0-or-later` |
...
| [`gRain`](gRain/) | Performs probability propagation and inference in Bayesian networks using junction trees. | `1.4.6` · `GPL-2.0-or-later` |
| [`gRbase`](gRbase/) | Provides graph, table, triangulation, and junction-tree computations for graphical models. | `2.0.3` · `GPL-2.0-or-later` |
...
| [`grf`](grf/) | Fits generalized random forests for regression, causal inference, quantiles, survival analysis, and related tasks. | `2.6.1` · `GPL-3.0-only` |
| [`grpreg`](grpreg/) | Fits grouped-penalty regularization paths for regression, generalized linear models, and survival models. | `3.6.0` · `GPL-3.0-only` |
...
| [`imputeTS`](imputeTS/) | Imputes missing time-series values using interpolation, smoothing, and model-based methods. | `3.4` · `GPL-3.0-only` |
...
| [`kde1d`](kde1d/) | Estimates univariate kernel densities with boundary handling, bandwidth selection, and distribution evaluation. | `1.2.2` · `MIT` |
...
| [`KFAS`](KFAS/) | Fits and analyzes Gaussian and non-Gaussian state-space models using Kalman methods. | `1.6.0` · `GPL-2.0-or-later` |
...
| [`lavaan`](lavaan/) | Fits confirmatory factor, structural-equation, and latent-variable models. | `0.7-2` · `GPL-2.0-or-later` |
| [`lbfgs`](lbfgs/) | Performs limited-memory BFGS and orthant-wise optimization. | `1.2.1.2` · `GPL-2.0-or-later` |
| [`lbfgsb3`](lbfgsb3/) | Performs bound-constrained L-BFGS-B optimization with additional stopping criteria. | `2024-3.5` · `GPL-2.0-only` |
...
| [`LearnBayes`](LearnBayes/) | Provides Bayesian teaching, inference, simulation, and posterior-computation algorithms. | `2.15.2` · `GPL-2.0-or-later` |
...
| [`lmtest`](lmtest/) | Provides diagnostic and hypothesis tests for linear regression models. | `0.9-40` · `GPL-2.0-only OR GPL-3.0-only` |
...
| [`lubridate`](lubridate/) | Provides typed date-time parsing, arithmetic, accessors, intervals, periods, durations, and rounding. | `1.9.5` · `MIT` |
...
| [`MARSS`](MARSS/) | Fits and analyzes multivariate autoregressive state-space models. | `3.11.10` · `GPL-2.0-only` |
...
| [`matrixdist`](matrixdist/) | Provides matrix-exponential and matrix phase-type distributions, fitting, regression, and simulation. | `1.1.9` · `GPL-3.0-only` |
| [`MatrixExtra`](MatrixExtra/) | Provides additional methods for sparse matrices. | `0.1.15` · `GPL-3.0-only` |
| [`matrixNormal`](matrixNormal/) | Provides matrix-variate normal distribution calculations and simulation. | `0.1.2` · `GPL-3.0-only` |
...
| [`MCMCglmm`](MCMCglmm/) | Fits Bayesian generalized linear mixed models using Markov-chain Monte Carlo methods. | `0.5.0` · `GPL-2.0-or-later` |
...
| [`mice`](mice/) | Performs multivariate imputation by chained equations and associated pooling and diagnostic computations. | `3.19.0` · `GPL-2.0-or-later` |
...
| [`multcomp`](multcomp/) | Performs simultaneous inference and multiple comparisons in parametric models. | `1.4-32` · `GPL-2.0-only` |
...
| [`nnet`](nnet/) | Fits feed-forward neural networks and multinomial log-linear models. | `7.3-21` · `GPL-2.0-only OR GPL-3.0-only` |
...
| [`otrimle`](otrimle/) | Performs robust clustering using optimally tuned improper maximum-likelihood mixture models. | `2.0` · `GPL-2.0-or-later` |
...
| [`poLCA`](poLCA/) | Fits latent class and latent class regression models for categorical observations. | `1.6.0.2` · `GPL-2.0-or-later` |
| [`polyaAeppli`](polyaAeppli/) | Provides the Polya-Aeppli distribution. | `2.0.2` · `GPL-2.0-or-later` |
| [`polyclip`](polyclip/) | Performs polygon clipping, simplification, offsetting, and point-in-polygon calculations. | `1.10-7` · `BSL-1.0` |
...
| [`proxy`](proxy/) | Computes distances and similarities for numeric, binary, nominal, mixed, and sequence data. | `0.4-29` · `GPL-2.0-only OR GPL-3.0-only` |
...
| [`purrr`](purrr/) | Provides typed functional programming operations over arrays. | `1.2.2` · `MIT` |
...
| [`qrng`](qrng/) | Generates randomized and deterministic Sobol, Halton, and Korobov quasi-random sequences. | `0.0-11` · `GPL-2.0-only OR GPL-3.0-only` |
...
| [`randomForest`](randomForest/) | Fits classification and regression random forests. | `4.7-1.2` · `GPL-2.0-or-later` |
| [`randompack`](randompack/) | Provides stateful random-number generators and univariate and multivariate distribution simulation. | `0.1.10` · `BSD-3-Clause` |
...
| [`ranger`](ranger/) | Fits fast random forests for classification, regression, probability, and survival models. | `0.18.0` · `GPL-3.0-only` |
...
| [`readr`](readr/) | Reads and writes heterogeneous rectangular text data. | `2.2.0` · `MIT` |
...
| [`Rmpfr`](Rmpfr/) | Provides arbitrary-precision arithmetic, special functions, probability kernels, and numerical algorithms using GNU MPFR. | `1.1.2` · `GPL-2.0-or-later` |
...
| [`roll`](roll/) | Computes rolling and expanding summaries, quantiles, covariance, correlation, and linear regression. | `1.2.1` · `GPL-2.0-or-later` |
...
| [`rpart`](rpart/) | Fits recursive-partitioning classification, regression, Poisson, and survival trees. | `4.1-27` · `GPL-2.0-or-later OR GPL-3.0-or-later` |
...
| [`Rssa`](Rssa/) | Provides singular spectrum analysis, reconstruction, forecasting, and related methods. | `1.1` · `GPL-2.0-or-later` |
...
| [`signal`](signal/) | Provides digital signal-processing, filter-design, resampling, spectral, and windowing routines. | `1.8-1` · `GPL-2.0-only` |
...
| [`spam`](spam/) | Provides sparse-matrix storage, Cholesky methods, eigensolvers, and spatial-statistics utilities. | `2.11-4` · `mixed; see package licenses` |
...
| [`SpatialExtremes`](SpatialExtremes/) | Models, fits, and simulates spatial extreme-value and max-stable processes. | `2.1-0` · `GPL-2.0-or-later` |
| [`spdep`](spdep/) | Provides spatial-neighbor, spatial-weight, autocorrelation, and spatial-regression computations. | `1.4-2` · `GPL-2.0-or-later` |
...
| [`stabledist`](stabledist/) | Evaluates, computes quantiles for, and simulates stable probability distributions. | `0.7-2` · `GPL-2.0-or-later` |
| [`statmod`](statmod/) | Provides statistical-modeling utilities including inverse-Gaussian methods, quadrature, REML, and randomized quantile residuals. | `1.5.2` · `GPL-2.0-only OR GPL-3.0-only` |
| [`stats`](stats/) | Provides selected base-R statistical computations, including regression, inference, smoothing, clustering, and time-series analysis. | `R 4.6.0` · `MIT` |
| [`SteadyStateBVAR`](SteadyStateBVAR/) | Fits steady-state Bayesian vector autoregressions with stochastic volatility, forecasting, and impulse responses. | `0.2.0` · `GPL-3.0-or-later` |
| [`stinepack`](stinepack/) | Performs Stineman interpolation, slope estimation, and missing-value gap filling. | `1.5` · `GPL-2.0-or-later` |
...
| [`stringr`](stringr/) | Provides consistent fixed-string matching and transformation operations. | `1.6.0` · `MIT` |
| [`strucchange`](strucchange/) | Tests, estimates, and monitors structural changes in regression and time-series models. | `1.6-0` · `GPL-2.0-only OR GPL-3.0-only` |
...
| [`svd`](svd/) | Provides interfaces to leading singular-value and eigenvalue solvers. | `0.5.8` · `BSD-3-Clause` |
...
| [`tclust`](tclust/) | Performs robust trimmed clustering, trimmed k-means, and clustering around affine subspaces. | `2.2-1` · `GPL-3.0-or-later` |
| [`tensorA`](tensorA/) | Provides advanced tensor arithmetic with named indices. | `0.36.2.1` · `GPL-2.0-or-later` |
| [`tibble`](tibble/) | Implements typed heterogeneous rectangular tables with explicit missingness. | `3.3.1` · `MIT` |
| [`tidyr`](tidyr/) | Provides deterministic tools for reshaping and tidying heterogeneous rectangular data. | `1.3.2` · `MIT` |
| [`tidyselect`](tidyselect/) | Selects columns and other names through composable selection helpers. | `1.2.1` · `MIT` |
| [`timsac`](timsac/) | Provides time-series analysis, prediction, and control methods. | `1.3.8-6` · `GPL-2.0-or-later` |
| [`TMB`](TMB/) | Provides portable probability, matrix, Gaussian-model, integration, and finite-difference kernels translated from TMB. | `1.9.25` · `GPL-2.0-only` |
| [`tmvtnorm`](tmvtnorm/) | Computes probabilities, moments, densities, simulation, and fitting for truncated multivariate normal and Student-t distributions. | `1.7` · `GPL-2.0-or-later` |
...
| [`TruncatedNormal`](TruncatedNormal/) | Computes probabilities and generates samples for truncated multivariate normal and Student-t distributions. | `2.3` · `GPL-3.0-only` |
| [`truncnorm`](truncnorm/) | Evaluates and simulates univariate truncated normal distributions. | `1.0-9` · `GPL-2.0-or-later` |
...
| [`tweedie`](tweedie/) | Evaluates and fits Tweedie exponential-dispersion distributions using series, interpolation, and inversion methods. | `3.1.0` · `GPL-2.0-or-later` |
| [`ucminf`](ucminf/) | Performs unconstrained optimization using BFGS updates and soft line searches. | `1.2.3` · `GPL-2.0-or-later` |
...
| [`urca`](urca/) | Performs unit-root, stationarity, cointegration, and structural-break analysis. | `1.3-4` · `GPL-2.0-or-later` |
...
| [`varmapack`](varmapack/) | Constructs and simulates VAR, VMA, VARMA, and VARMAX models, with autocovariances and impulse responses. | `0.1.1` · `MIT` |
| [`vars`](vars/) | Fits, diagnoses, forecasts, and analyzes vector autoregressive and structural VAR models. | `1.6-1` · `GPL-2.0-or-later` |
| [`vasicekfit`](vasicekfit/) | Fits the extended Vasicek credit-loss model. | `0.2.0` · `MIT` |
| [`vctrs`](vctrs/) | Provides type- and size-stable operations for typed vectors. | `0.7.3` · `MIT` |
...
| [`wavelets`](wavelets/) | Computes discrete and maximal-overlap wavelet transforms, inverse transforms, and multiresolution analyses. | `0.3-0.2` · `GPL-2.0-or-later` |
| [`waveslim`](waveslim/) | Provides one-, two-, and three-dimensional wavelet methods. | `1.8.5` · `BSD-3-Clause` |
| [`wavethresh`](wavethresh/) | Provides wavelet transforms, thresholding, shrinkage, and related statistical methods. | `4.7.3` · `GPL-2.0-or-later` |
