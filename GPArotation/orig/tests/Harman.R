...
qHarman2 <- quartimax(Harman8) 
 ...
 if( fuzz < max(abs(qHarman$loadings - qHarman2$loadings))) {
    ...
    cat("difference:\n")
    print(unclass(qHarman$loadings - qHarman2$loadings), digits=18)
    all.ok <- FALSE  
    } 
...
# with eps=1e-5
 ...
 if( fuzz < max(abs(qHarman$loadings - tst ))) {
    ...
    print(qHarman$loadings, digits=18)
    cat("difference:\n")
    print(unclass(qHarman$loadings - tst), digits=18)
    all.ok <- FALSE  
    } 
...
qminHarman2 <- quartimin(Harman8) 
 ...
 if( fuzz < max(abs(qminHarman$loadings - qminHarman2$loadings))) {
    ...
    cat("difference:\n")
    print(unclass(qminHarman$loadings - qminHarman2$loadings), digits=18)
    all.ok <- FALSE  
    } 
...
# with eps=1e-5
 ...
 if( fuzz < max(abs(qminHarman$loadings - tst ))) {
    ...
    print(qminHarman$loadings, digits=18)
    cat("difference:\n")
    print(unclass(qminHarman$loadings - tst), digits=18)
    all.ok <- FALSE  
    } 
