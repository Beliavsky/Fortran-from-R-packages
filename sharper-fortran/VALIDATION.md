...
- Release Fortran line count: 3,243 across 17 source, test, demo, and example files.
...
- `test_unified`: empirical and Gaussian second-moment covariance estimators,
  inverse-moment delta propagation, and exact cross-platform covariance symmetry.
...
whether the route uses direct evaluation or nested numerical inversion. The
`ism_vcov` result is explicitly symmetrized and tested for exact symmetry to
prevent Windows/Linux floating-point evaluation differences.
