...
# NOTE: This retained provenance excerpt intentionally omits the deprecated
# plotting wrappers that follow in the upstream file. They are outside the
# computational translation scope.
