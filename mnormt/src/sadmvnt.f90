...
!
EXTERNAL MVNFNC
INTEGER I, N, NL, M, INFIN(*), LENWRK, MAXPTS, INFORM, INFIS, &
...
INTEGER I, LG, NG
PARAMETER ( ZERO = 0, TWOPI = 6.283185307179586 )
...
PARAMETER ( SQTWPI = 2.50662827463100050240 )
IJ = 0
II = 0
INFIS = 0
DO I = 1,N
...
PARAMETER ( ZERO = 0, TWO = 2, PI = 3.14159265358979323844 )
IJ = 0
II = 0
INFIS = 0
DO I = 1, N
...
PARAMETER ( PI = 3.141592653589793D0, ZERO = 0 )
IF ( NU .EQ.1 ) THEN
...
PARAMETER ( PI = 3.141592653589793D0, TWO = 2  )
