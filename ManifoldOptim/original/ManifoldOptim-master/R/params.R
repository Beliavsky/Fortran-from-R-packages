...
#' from `get.solver.params`, via standard list manipulation. Interested
#' users should refer to Huang et al (2016b) for available options.
#'
#' @param isconvex Indicator for whether the function is convex (`TRUE` or
#'        `FALSE`)
...
#'        validated by the `get.solver.params` function. Users should 
...
#'
#' @param EpsNumericalGrad The "epsilon" used to perturb the objective function
#'        when computing numerical gradients
#' @param EpsNumericalHessEta The "epsilon" used to perturb the objective
#'        function when computing numerical `HessEta`
#'
