...
! Active-set quadratic-programming and projection routines for NMOF.
module nmof_qp
   use nmof_kinds, only: dp
   use nmof_linalg, only: solve_linear, vector_norm2, identity_matrix
   use nmof_types, only: nmof_ok, nmof_infeasible, nmof_linear_solve_failed, nmof_max_iter
   implicit none
   private
