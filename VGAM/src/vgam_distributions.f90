...
module vgam_distributions
   use, intrinsic :: ieee_arithmetic, only : ieee_value, ieee_quiet_nan, ieee_positive_inf
   use vgam_kinds, only : dp, pi, sqrt2, log2pi
   use vgam_special, only : normal_pdf, normal_cdf, normal_quantile, log1p_v, expm1_v, &
      regularized_gamma_p, regularized_beta, gamma_quantile, log_beta_fn, zeta_fn, &
      harmonic_generalized, lambert_w0
   use vgam_random, only : random_normal, random_exponential, random_gamma, random_beta, &
