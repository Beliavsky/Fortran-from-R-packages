...
!  =====================================================================
!
!     Computes the counts (frequencies) of values in vector x by
!     assigning them to bins specified in vector bins.
!
!     Input:
!       x     - Integer vector of values
!       n     - Length of vector x
!       bins  - Integer vector of bin values
!       m     - Length of vector bins
!
!     Output:
!       freq  - Integer vector of frequencies for each bin value
!
  implicit none
  integer          :: n, m, i, j
